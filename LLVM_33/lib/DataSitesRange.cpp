...
set<Instruction*> DataSitesRange::getfaultSites(Module *M, CLData *Cl, FunctionList *Fl){
  ...
  set<Instruction*> instrList = DataSites::getfaultSites(M,Cl,Fl);
...
void DataSitesRange::populateRangeDS(Module *M, CLData *Cl){
